        ...
        >
            <View
                style={{
                    ...
                    backgroundColor: variant === "Calory" ? COLORS.bgCalory : variant === "Fiber" ? COLORS.bgFiber : COLORS.bgWater,
                    borderWidth: 2,
                ...
                >
                    <View>
                        ...
                        >
                            ...
                            >
                                {variant === "Calory" ? 'kcal/day' : variant === "Fiber" ? 'g/day' : 'l/day'}
                            </Text>
                        </View>
                    ...
                    <Image
                        source={variant === "Calory" ? NUTRIENTS.calory : variant === "Fiber" ? NUTRIENTS.fiber : NUTRIENTS.water}
                ...
                >
                    {dates.map((item, index) => (
                        <DayBar
                            key={index}
                            variant={variant}
                            num={inData[index] > 0 ? variant === 'Fiber' ? inData[index] : inData[index].toFixed(1) : ""}
                            height={height[index]}
                            date={item}
                        />
                    ))}
