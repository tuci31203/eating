            ...
            {open &&
                (<>
                    ...
                    <View style={styles.content}>
                        <Text style={[styles.text, styles.ingre]}>{ingredients}</Text>
                        <Text style={[styles.text, styles.instruction]}>{instructions}</Text>
                        <Text style={[styles.text, styles.time]}>Total time: {recipe.totalTime}</Text>
                    </View>
                </>
                )}
        </View>
