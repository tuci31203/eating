export const recipesMock = [
  ...
  },
  {
    ...
    instructions: [
      "In a large bowl, sift together the flour, sugar, baking powder, and salt. Make a well in the center and pour in the milk, egg, and oil. Mix until smooth.",
  ...
  },
  {
    ...
    instructions: [
      "In a large bowl, combine lettuce, tomato, cucumber, onion, carrot, and bell pepper.",
  ...
  },
  {
    ...
    instructions: [
      "In a blender, combine banana, strawberry, milk, yogurt, and honey. Blend until smooth.",
    ],
    totalTime: "5 minutes",
  },
  {
    ...
    instructions: [
      "In a large pot, heat oil over medium heat. Add onion, carrot, and celery; cook and stir until onion is tender.",
  ...
  },
  {
    ...
    instructions: [
      "In a bowl, combine soy sauce, oyster sauce, cornstarch, and water. Set aside.",
  ...
  },
  {
    ...
    instructions: [
      "In a large skillet, cook beef, onion, and garlic over medium heat until beef is browned. Drain.",
  ...
  },
  {
    ...
    instructions: [
      "In a saucepan, bring water to a boil. Add tea leaves and sugar. Simmer for 5 minutes.",
  ...
  },
  {
    ...
    instructions: [
      "In a large bowl, combine beef, onion, garlic, salt, and pepper. Form into patties.",
  ...
  },
  {
    ...
    instructions: [
      "Preheat the oven to 450°F. Roll out the dough on a floured surface.",
  ...
  },
  {
    ...
    instructions: [
      "In a large pot, heat oil over medium heat. Add onion, garlic, and ginger; cook until onion is tender.",
  ...
  },
  {
    ...
    units: ["cup", "cup", "tsp"],
    instructions: [
      "In a saucepan, bring water to a boil. Add rice and salt. Cover and simmer for 18 minutes.",
    ],
